...
trait CreateRegistrationTokenForm
{
     ...
     */
    public function getCreateRegistrationPaymentForm($checkoutId, $shopperResultUrl, $dataBrands = [CatalystPaySDK::PAYMENT_BRAND_VISA . ' ' . CatalystPaySDK::PAYMENT_BRAND_MASTERCARD . ' ' . CatalystPaySDK::PAYMENT_BRAND_AMEX])
    {
        return $this->getCreateRegistrationFormScript($checkoutId) . $this->getRegistrationPaymentForm($shopperResultUrl, $dataBrands);
    }
     ...
     * @return string The HTML form with payment widgets.
     */
    public function getRegistrationPaymentForm($shopperResultUrl = '', $dataBrands = [])
    {
     ...
     */
    public function getCreateRegistrationFormScript($checkoutId)
    {
        return '<script src='
            . '"' . $this->getCreateRegistrationFormScriptUrl($checkoutId) . '"'
            . '></script>';
    }
